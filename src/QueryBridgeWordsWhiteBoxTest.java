...
public class QueryBridgeWordsWhiteBoxTest {
    ...
    // Path 3: word1 in graph but no bridge
    @Test
    public void test_P3_noBridgeWords() throws Exception {
        prepareGraph("a b c");
        String result = invoke("c", "a");  // "c" has no outgoing edge to "a"
        assertTrue(result.contains("No bridge words"));
    }

    // Path 4: one bridge word
    @Test
    public void test_P4_oneBridgeWord() throws Exception {
        prepareGraph("a b c");
    ...
    // Path 5: multiple bridge words
    @Test
    public void test_P5_multipleBridgeWords() throws Exception {
